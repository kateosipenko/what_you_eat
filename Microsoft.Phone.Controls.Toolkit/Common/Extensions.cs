...
namespace Microsoft.Phone.Controls
{
    ...
    public static partial class Extensions
    {
        ...
        /// </summary>
        /// <param name="currentMatrix">The Matrix object.</param>
        ...
        public static bool Invert(this Matrix currentMatrix, out Matrix outputMatrix)
        {
            double determinant = currentMatrix.M11 * currentMatrix.M22 - currentMatrix.M12 * currentMatrix.M21;
            if (determinant == 0.0)
            {
            ...
            Matrix matCopy = currentMatrix;
            currentMatrix.M11 = matCopy.M22 / determinant;
            currentMatrix.M12 = -1 * matCopy.M12 / determinant;
            currentMatrix.M21 = -1 * matCopy.M21 / determinant;
            currentMatrix.M22 = matCopy.M11 / determinant;
            currentMatrix.OffsetX = (matCopy.OffsetY * matCopy.M21 - matCopy.OffsetX * matCopy.M22) / determinant;
            currentMatrix.OffsetY = (matCopy.OffsetX * matCopy.M12 - matCopy.OffsetY * matCopy.M11) / determinant;
        ...
        /// </summary>
        /// <param name="currentString">The string.</param>
        /// <param name="value">The string value to search for.</param>
        /// <param name="comparison">The string comparison type.</param>
        /// <returns>Returns true when the substring is found.</returns>
        public static bool Contains(this string currentString, string value, StringComparison comparison)
        {
            return currentString.IndexOf(value, comparison) >= 0;
        }
